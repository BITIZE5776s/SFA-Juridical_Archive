...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-4 relative overflow-hidden">
      {/* Background Pattern */}
